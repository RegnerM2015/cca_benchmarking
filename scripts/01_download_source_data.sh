...
singularity exec --bind /Users \
                 --home $PWD \
                 docker://regnerm/scbreast_2023:1.1.2 \
                 mkdir source_data &&
...
singularity exec --bind /Users \
                 --home $PWD \
                 docker://regnerm/scbreast_2023:1.1.2 \
                 wget -P ./source_data/ https://ftp.ncbi.nlm.nih.gov/geo/series/GSE176nnn/GSE176078/suppl/GSE176078%5FWu%5Fetal%5F2021%5FBRCA%5FscRNASeq%2Etar%2Egz &&
                 tar -xzf ./source_data/GSE176078_Wu_etal_2021_BRCA_scRNASeq.tar.gz -C source_data &&
